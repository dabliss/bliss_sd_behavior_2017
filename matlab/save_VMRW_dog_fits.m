function save_VMRW_dog_fits(project_dir, k)
% function save_VMRW_attraction_fits(project_dir, k)
%
% Parameters
% ----------
% k : integer
...
[params_hat, params_0, log_like] = fit_VMRW_dog(all_data);
...
attempt = 1;
while 1
    f_name = sprintf('s%03d_%02d_VMRW_dog_%02d.mat', s, delays(d), attempt);
