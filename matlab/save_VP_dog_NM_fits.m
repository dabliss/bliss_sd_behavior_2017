function save_VP_dog_NM_fits(project_dir, k)
% function save_EP_H_NM_fits(project_dir, k)
%
% Parameters
% ----------
% project_dir : string
...
[params_hat, params_0, log_like] = fit_VP_dog_NM(all_data);
...
attempt = 1;
while 1
    f_name = sprintf('s%03d_%02d_VP_dog_NM_%02d.mat', s, delays(d), attempt);
