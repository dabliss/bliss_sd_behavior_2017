function vswm_task_variable_iti(session)
% function vswm_task_variable_iti(session)
...
for i = 1:n_trials
    ...
    [~, stim_start] = Screen('Flip', window, fix_start + ...
        session_details(i).iti);
    ...
    [~, probe_start] = Screen('Flip', window, delay_start + delay_time);
